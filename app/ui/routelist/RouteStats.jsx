      ...
      <div className="mx-auto max-w-7xl p-4">
        <div className="flex flex-col gap-4">
          {routeData?.map((route, index) => (
            <div key={index} className="bg-poke-black my-2 px-4 py-4 rounded-2xl">
              <div className="bg-poke-black px-4 py-4">
                <button
              ...
              {expandedSections[index] && (
                <div className="bg-poke-black mt-2 rounded-2xl">
                  {route.version_details?.map((version, vIndex) => (
                    <div key={vIndex} className="bg-poke-black px-4 py-4 mt-2 border-t border-[var(--poke-white)]">
